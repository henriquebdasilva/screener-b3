...
def _legenda_scores() -> str:
    ...
    return ('<p class="sub" style="margin:4px 0 14px">'
           ...
           '(EBITDA, margem, ROE, ROIC, LUCRO e PATRIMÔNIO LÍQUIDO em tendência de alta — '
           'pune quem tem lucro ou patrimônio encolhendo, mesmo que P/L ou ROE do momento '
           'pareçam bons só por causa disso) que foram atendidos — X/Y entre '
